...
Bem-vindo ao meu repositório de soluções dos desafios do [Frontend Mentor](https://www.frontendmentor.io/)!

## Sobre o Frontend Mentor

O **Frontend Mentor** é uma plataforma que oferece desafios práticos de front-end para desenvolvedores de todos os níveis. 
Cada desafio inclui designs profissionais (Figma, Sketch ou Adobe XD) e um conjunto de requisitos para você implementar usando HTML, CSS e JavaScript — sem restrições de frameworks ou bibliotecas.

É uma forma prática de:
- Treinar habilidades de codificação
- Trabalhar com designs realistas
